...
export function pluginInfo() {
  return {
    ...
    // Host verified against every URL literal in the original Perl source
    // (~/LANraragi/lib/LANraragi/Plugin/Metadata/nHentai.pm): nhentai.net.
...
export async function execMetadata(hostArgs: Record<string, unknown>) {
  ...
  if ((match = lrr_info["oneshot_param"].match(/.*\/g\/([0-9]+).*/))) {
    galleryID = match[1];
